...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        ...
        open(11,file='pregsk.dat',status='unknown')
        open(12,file='pregsno.dat',status='unknown')
        open(13,file='pregsg.dat',status='unknown')
        open(14,file='preggno.dat',status='unknown')
        ntg=9
        ndm=200       
        do itg=0,ntg
