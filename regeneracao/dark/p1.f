...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        ...
        open(11,file='pregsk.1dat',status='unknown')
        open(12,file='pregsno.1dat',status='unknown')
        open(13,file='pregsg.1dat',status='unknown')
        open(14,file='preggno.1dat',status='unknown')
        ntg=9
        ndm=200       
        do itg=0,4!ntg
